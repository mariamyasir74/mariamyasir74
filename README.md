...
| 🎭 **Sentiment Analyzer** | نواة محادثة ذكية تعتمد على الذاكرة المستمرة ودمج LangGraph. | `LangGraph`, `RAG`, `Ollama` |
| 💳 **Credit Card Fraud Detector** | مساعد ذكي مخصص للموظفين لتوليد محادثات موجهة. | `RAG`, `LLM`, `pandas` |
